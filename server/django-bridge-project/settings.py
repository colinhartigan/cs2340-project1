"""
Django settings for django-bridge-project project.
...
SECRET_KEY = "r@cvcj=qmb$p@*^v94&%zgg=(js@98x@f*@^l^tnl=-+k1=vx*" # this is insecure but easier for development
...
ROOT_URLCONF = "django-bridge-project.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            BASE_DIR / "django-bridge-project" / "templates",
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "django-bridge-project.wsgi.application"
